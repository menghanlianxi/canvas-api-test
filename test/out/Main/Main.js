...
var mc_stand = new engine.MovieClip(standData);
mc_stand.scaleX = 0.7;
mc_stand.scaleY = 0.7;
var mc_moveR = new engine.MovieClip(moveRightData);
mc_moveR.scaleX = 0.7;
mc_moveR.scaleY = 0.7;
var mc_fight = new engine.MovieClip(fightData);
mc_fight.scaleX = 0.7;
mc_fight.scaleY = 0.7;
var mc_moveL = new engine.MovieClip(moveLeftData);
mc_moveL.scaleX = 0.7;
mc_moveL.scaleY = 0.7;
/*
    角色与状态机
...
var task2 = new Task("task2", "杀敌", "击杀10个敌人", "npc_1", "npc_1", 2, killMonsterTaskCondition, taskservice);
...
box_bitmap.addEventListener(engine.MouseState.MOUSE_CLICK, function () {
